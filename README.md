...
**選択範囲**: 選択した範囲の簡単な要約が表示されます。バイト数により，自動的なASCII変換が実行されます。``1``バイトは，バイト値が16進数・10進数・文字として表示されます。``2``バイトは，整数値が16進数・10進数・テキストで表示されます。``3-4``バイトは，倍長整数値が整数値が16進数・10進数・テキストで表示されます。``8``バイトは，整数値が16進数・10進数・テキストで表示されます。それよりも長い範囲を選択した場合，範囲だけが表示されます。数値（8バイトまで）は，自動的にビッグエンディアンに変換されて表示されます。
